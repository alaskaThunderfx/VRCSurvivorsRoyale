...
public class LilWolf : UdonSharpBehaviour
{
    [Header("Components")]
    public NavMeshAgent Agent;
    public VRCPlayerApi Owner;
    private VRCPlayerApi LocalPlayer;
    public VRCObjectPool LilWolfPool;

    public Cyan.PlayerObjectPool.CyanPlayerObjectAssigner PlayerObjectAssigner;
    public PlayerController PlayerController;

    public LilWolfSpawner LilWolfSpawner;
    ...
    private void OnEnable()
    {
        ...
        LilWolfPool = GameObject.Find("LilWolfSpawner").GetComponent<VRCObjectPool>();
        LilWolfSpawner = GameObject.Find("LilWolfSpawner").GetComponent<LilWolfSpawner>();
        ...
        if (IsDying)
        {
            ...
            if (DeathScene <= 0)
            {
                ...
                if (Networking.LocalPlayer == Owner)
                {
                    ...
                    LilWolfPool.Return(gameObject);
                    LilWolfSpawner.NumberOfWolfs -= 1;
                }
            }
        }
    ...
    public float Health
    {
        set
        {
            ...
            if (health <= 0)
            {
                ...
                Networking.SetOwner(Owner, LilWolfPool.gameObject);
                Agent.enabled = false;
